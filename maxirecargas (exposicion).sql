...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-04-2018 a las 11:36:31
...
(21, 1, 9904, 'Cristian', 'Alexis', 'Lopera', 'Lopera', 'yonosoybond@gmail.com', 4887088, 1, 'calle 95', 3233557660, '2018-04-04', 'masculino', 2, 1, 'default.jpg', '2018-04-05', '2018-04-05'),
...
(24, 1, 1214, 'Cristian', '', 'Lopera', '', 'caloper@misena.edu.co', 78, 1, 'calle 95 b', 67587, '2018-04-03', 'masculino', 1, 1, 'default.jpg', '2018-04-05', '2018-04-05'),
...
--
ALTER TABLE `cliente_empresarial`
  MODIFY `id_cliente_empresarial` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `empresa`
  MODIFY `emp_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `historial_productos`
  MODIFY `id_his_pro` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `sede`
  MODIFY `sed_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
