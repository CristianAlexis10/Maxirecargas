    ...
    <div class="frmprofile">
      <form>
        <div class="wrap_two_formgroup">
          ...
          <div class="form-group">
            <label for="segNom" class="label">Secundo nombre:</label>
            <input type="text" id="segNom" class="input dataCl" required>
          </div>
        </div>
        <div class="wrap_two_formgroup">
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" id="segApe" class="input dataCl" required>
          </div>
        </div>
        <div class="wrap_two_formgroup">
          <div class="form-group">
        ...
        <div class="wrap_two_formgroup">
          <div class="form-group">
            ...
            <input type="text" class=" input dataCl" id="celular" required>
          </div>
          <div class="form-group">
            <label for="tel" class="label">Fecha de nacimiento:</label>
            <input type="date" class="input dataCl" id="tel"  required>
          </div>
        </div>
        <div class="wrap_two_formgroup">
          <div class="form-group">
